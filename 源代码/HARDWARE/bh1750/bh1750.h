...
#define BH1750_SDA_IN()  {GPIOB->CRH&=0XFFFFFFF0;GPIOB->CRH|=(u32)8<<0;}
#define BH1750_SDA_OUT() {GPIOB->CRH&=0XFFFFFFF0;GPIOB->CRH|=(u32)3<<0;}

//IO操作函数	 
#define BH1750_IIC_SCL    PBout(9) //SCL
#define BH1750_IIC_SDA    PBout(8) //SDA	 
#define BH1750_READ_SDA   PBin(8)  //输入SDA 
